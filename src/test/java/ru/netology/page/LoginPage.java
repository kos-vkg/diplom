...
public class LoginPage {
    ...
    private SelenideElement monthField = $$("[tabindex='-1'] input").get(0);
    private SelenideElement yearField = $$("[tabindex='-1'] input").get(1);
    private SelenideElement nameField = $$("[tabindex='-1'] input").get(2);
    private SelenideElement cvsField = $$("[tabindex='-1'] input").get(3);
